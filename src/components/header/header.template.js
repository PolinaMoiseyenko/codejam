                ...
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item language-select dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                      ...
                      href="${getLink(window.location.origin + window.location.pathname, 'ru', true)}">русский</a>
                      <a class="dropdown-item" 
                      href="${getLink(window.location.origin + window.location.pathname, 'en', true)}">english</a>
                      <a class="dropdown-item" 
                      href="${getLink(window.location.origin + window.location.pathname, 'by', true)}">беларускі</a>
                    </div>
                  </li>
                </ul>
              </div>
